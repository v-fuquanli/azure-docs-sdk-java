...
keywords: Azure, java, SDK, API, azure-messaging-eventhubs-checkpointstore-jedis, azure-event-hubs
ms.date: 06/26/2025
ms.topic: reference
ms.devlang: java
ms.service: azure-event-hubs
---
# Azure Event Hubs Checkpoint Store client library for Java - version 1.0.0-alpha.20250626.1 
