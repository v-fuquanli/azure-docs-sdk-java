...
keywords: Azure, java, SDK, API, azure-resourcemanager-eventhubs, azure-event-hubs
ms.date: 06/27/2025
ms.topic: reference
ms.devlang: java
ms.service: azure-event-hubs
---
# Azure Resource Manager EventHubs client library for Java - version 2.52.0-alpha.20250626.5 
