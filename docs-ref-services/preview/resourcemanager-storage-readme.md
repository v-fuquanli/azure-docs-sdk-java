...
keywords: Azure, java, SDK, API, azure-resourcemanager-storage, resourcemanager
ms.date: 06/27/2025
ms.topic: reference
ms.devlang: java
ms.service: resourcemanager
---
# Azure Resource Manager storage client library for Java - version 2.52.0-alpha.20250626.5 
